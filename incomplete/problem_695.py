...
URI: https://projecteuler.net/problem=695
Difficulty: ?

Status: Incomplete

Ref: https://wiki.python.org/moin/PointsAndRectangles
...
Problem:
    ...
    P2P3 (see picture below).
    
    We are interested in the rectangle with the second biggest area. In the example
    above that happens to be the green rectangle defined with the diagonal P2P3.
...
unit_square = Rect(Point(0,0), Point(10,10))

p1 =  Point(1, 3)
p2 =  Point(5, 5)
p3 =  Point(6, 1)

if unit_square.contains(p1) and unit_square.contains(p2):
    inscr_rect_1 = Rect(p1, p2)

if unit_square.contains(p1) and unit_square.contains(p3):
    inscr_rect_2 = Rect(p1, p3)

if unit_square.contains(p2) and unit_square.contains(p3):
    inscr_rect_3 = Rect(p2, p3)
